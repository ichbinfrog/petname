...
func (g *Generator) getName() (int, string) {
	index := rand.Intn(len(g.Names))
	g.AvailableName--
	return index, g.Names[index]
}

func (g *Generator) getAdjective() (int, string) {
	index := rand.Intn(len(g.Adjectives))
	g.AvailableAdj--
	return index, g.Adjectives[index]
}

func (g *Generator) getAdverb() (int, string) {
	index := rand.Intn(len(g.Adverbs))
	g.AvailableAdv--
	return index, g.Adverbs[index]
}
...
func (g *Generator) New(t string, n string, s string) {
	...
	g.AvailableAdj = len(g.Adjectives)
	g.AvailableName = len(g.Names)
	g.AvailableAdv = len(g.Adverbs)
